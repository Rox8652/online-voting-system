...
function getVote(int) {
  ...
  xmlhttp.open("GET","poll1_vote.php?vote="+int,true);
  xmlhttp.send();
}
</script>
</head>
...
<form>
Saurabha: <input type="radio" name="vote" value="0" onclick="getVote(this.value)"><br>
Rohan: <input type="radio" name="vote" value="1" onclick="getVote(this.value)"><br>
Rohit:<input type="radio" name="vote" value="2" onclick="getVote(this.value)">
