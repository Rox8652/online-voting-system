...
function getVote(int) {
  ...
  xmlhttp.open("GET","zoompoll.php?vote="+int,true);
  xmlhttp.send();
}
</script>
</head>
...
<form>
a) 1-2 hours: <input type="radio" name="vote" value="0" onclick="getVote(this.value)"><br>
b) 2-5 hours: <input type="radio" name="vote" value="1" onclick="getVote(this.value)"><br>
c) 5-8 hours:<input type="radio" name="vote" value="2" onclick="getVote(this.value)">
