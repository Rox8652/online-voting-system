...
function getVote(int) {
  ...
  xmlhttp.open("GET","rolepoll.php?vote="+int,true);
  xmlhttp.send();
}
</script>
</head>
...
<form>
IT: <input type="radio" name="vote" value="0" onclick="getVote(this.value)"><br>
Business Development: <input type="radio" name="vote" value="1" onclick="getVote(this.value)"><br>
Technical Development:<input type="radio" name="vote" value="2" onclick="getVote(this.value)">
