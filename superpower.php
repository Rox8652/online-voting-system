...
function getVote(int) {
  ...
  xmlhttp.open("GET","superpoll.php?vote="+int,true);
  xmlhttp.send();
}
</script>
</head>
...
<form>
Mind reading: <input type="radio" name="vote" value="0" onclick="getVote(this.value)"><br>
Invisibility: <input type="radio" name="vote" value="1" onclick="getVote(this.value)"><br>
Flying:<input type="radio" name="vote" value="2" onclick="getVote(this.value)">
