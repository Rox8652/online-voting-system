...
function getVote(int) {
  ...
  xmlhttp.open("GET","owlpoll.php?vote="+int,true);
  xmlhttp.send();
}
</script>
</head>
...
<form>
Early bird: <input type="radio" name="vote" value="0" onclick="getVote(this.value)"><br>
Night owl: <input type="radio" name="vote" value="1" onclick="getVote(this.value)">
